import {
    ...
    CATEGORY_RESET_SUCCESS,
    CATEGORY_CREATE_FAIL,
    CATEGORY_DETAILS_REQUEST,
    CATEGORY_DETAILS_SUCCESS,
    CATEGORY_DETAILS_FAIL,
    CATEGORY_PAY_REQUEST,
    CATEGORY_PAY_SUCCESS,
    CATEGORY_PAY_FAIL,
    CATEGORY_PAY_RESET,
    CATEGORY_DELIVERED_REQUEST,
    CATEGORY_DELIVERED_SUCCESS,
    CATEGORY_DELIVERED_FAIL,
    CATEGORY_DELIVERED_RESET,
    CATEGORY_LIST_MY_REQUEST,
    CATEGORY_LIST_MY_SUCCESS,
    CATEGORY_LIST_MY_FAIL,
    CATEGORY_LIST_MY_RESET,
    CATEGORY_LIST_MY_ALL,
